...
I don’t talk about this much, but in the past year I started another company with a few friends. We named it [Hey, Good Game](https://www.hey.gg/). 
...
We briefly thought about naming the podcast after our weekly newsletter, “[Game On!](https://www.hey.gg/newsletter)”, but there were already a number of podcasts with this same name. Because we’re small, there was no great reason to add more complexity to this issue. 
...
Going into this podcast, I knew I didn’t want to edit the audio, along with everything else we needed to do. Even though [Descript](https://www.descript.com?lmref=C1InTA) makes it easy to edit, I wanted to have a polished podcast that felt branded, and for our guests to feel like this was a premium experience. 
...
I signed up for [Podium](https://hello.podium.page/), an AI tool for podcasts that does all of this automatically.
...
[Transistor](https://transistor.fm/) offers its own website hosting, and [Podpage](https://www.podpage.com/) does a great job of this too. But to be honest, it seems everyone uses these, and they all look terribly boring. It’s not their fault, but they’re catering to the masses. 
...
Framer ([*get 3 free months*](https://www.framer.com/?via=kadlac)) has a flexible CMS which gives you the ability to easily create custom dynamic fields that are easy to update. I have separate collections for blog and podcast, even though their powered the same way.
...
Inspired by [StarterStory](https://www.starterstory.com/) and [Hampton](https://joinhampton.com/), we want to create evergreen stories from game creators that are more interesting to read than a transcript of the episode. 

So we hired a writer to take the interview, and distill it down into a digestible format like [this one](https://www.hey.gg/blog/xordle) for the game, Xordle.
...
There's something about a defining audio bumper. All of my favorite podcasts have one. From [Tim Ferris](https://open.spotify.com/show/5qSUyCrk9KR69lEiXbjwXM?si=ba39a2e645e94335), to [Smartless](https://open.spotify.com/show/0Yzd0g8NYmn27k2HFNplv7?si=3a7731d290214ef9), they create a simple audio bumper that draws you in, letting you know you’re in the right place. I loved the one we created for my last show, [It’s Gotta Be the Mic](https://open.spotify.com/show/3g8s8leljx8zzfPVSacSlj?si=90c3023ed9ee4a5d). 

This is not something I could do myself, and so I sought out recommendations for audio engineers to create one. I was referred to [David Gonzalez](https://www.dgonzalezmusic.com/), who does exactly that. He came up with our intro/outro, and the bits and pieces in between. 
